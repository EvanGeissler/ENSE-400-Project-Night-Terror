...
void ACapstoneCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent){
    ...
    PlayerInputComponent->BindAxis("Run", this, &ACapstoneCharacter::Run);
    ...
    //Crouching
  //  PlayerInputComponent->BindAxis("Crouch", this, &ACapstoneCharacter::Crouch);
}
...
void ACapstoneCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location){
...
void ACapstoneCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location){
...
//void ACapstoneCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
void ACapstoneCharacter::Run(float Value){
    if (Value != 0.0f){
        // add running
        AddMovementInput(GetActorForwardVector(), 10000);
    }
}

//void ACapstoneCharacter::Crouch(){
